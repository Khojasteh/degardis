...
class ReaderHarness(unittest.TestCase):
    ...
    def knowledge(self, fields: str, body: str = "Body text."):
        return self.read(read_knowledge, "knowledge/change-surface.md", fields, body)
...
class SourceIdentityTests(unittest.TestCase):
    ...
    def test_a_byte_order_mark_does_not_hide_the_frontmatter(self):
        """Some Windows editors and shells open every UTF-8 file with one, and the
        author sees a file that opens with its fence."""
