"""The YAML subset this format accepts, and what the loader refuses outside it."""
...
class LoaderSubsetTests(unittest.TestCase):
    """This format accepts mappings, lists, strings, integers, finite numbers,
    ...
    def test_reads_a_field_name_as_the_text_on_the_page(self):
        """YAML 1.1 would read `on:`, `no:`, and `yes:` keys as booleans.
